...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="DrundushkaBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" DrundushkaBot.BotInitializer %CMD_LINE_ARGS%
